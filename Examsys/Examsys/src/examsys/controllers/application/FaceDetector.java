...
import examsys.controllers.Answer_examController;
                            ...
                            for (int i = 0; i < total; i++) {
                                ...
                                if (isRecFace) {
                                    ...
                                    if (recogniseCode != -1) {
                                        ...
                                        if (user.get(1).equals(LoggedInStudent.getStudent().getFirstname())) {
                                            ...
                                            javafx.application.Platform.runLater(new Runnable() {
                                                ...
                                                public void run() {
                                                    try {
                                                        ...
                                                        FXMLLoader loader = new FXMLLoader(getClass().getResource("answer_exam.fxml"));
